...
# 모델과 가중치 파일 경로
model_xml = "/home/ubuntu/workdir/test_0627/YOLOX_X_FP16/model/model.xml"
model_bin = "/home/ubuntu/workdir/test_0627/YOLOX_X_FP16/model/model.bin"
...
while cap.isOpened():
    ...
    for detection in result[0]:
        ...
        if confidence > 0.8:  # 신뢰도가 0.5보다 큰 경우만 고려
